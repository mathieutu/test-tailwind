    ...
    <div class="relative px-6 -mt-12">
      <div class="p-6 bg-white rounded-lg shadow-lg">
        <div class="text-xs font-semibold tracking-wide text-gray-600 uppercase">
          <span class="inline-block px-2 text-teal-700 uppercase bg-teal-200 rounded-full">New</span>
          <span class="ml-2">{{ property.beds }} beds &bull; {{ property.baths }} baths</span>
        </div>
